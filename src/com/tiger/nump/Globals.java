...
class Globals {
	public static String ApplicationName = "TigerNP_v0.2";

	//public static String AppLibraries[] = { "sdl-1.2", "sdl_image" };

	public static String AppLibraries[] = { "tigernump" };	
	
	public static final boolean Using_SDL_1_3 = false;

	// Should be zip file
	public static String DataDownloadUrl = ""; //"Data files size is 11 Mb|tyrian21-data.zip|http://sourceforge.net/projects/libsdl-android/files/OpenTyrian/tyrian21-data.zip/download|http://sites.google.com/site/xpelyax/Home/tyrian21-data.zip?attredirects=0%26d=1|http://sitesproxy.goapk.com/site/xpelyax/Home/tyrian21-data.zip";
	...
	public static boolean HorizontalOrientation = false;
	...
	public static boolean AppNeedsArrowKeys = false; //true;

	public static boolean AppNeedsTextInput = false ;//true;
	...
	public static int AppTouchscreenKeyboardKeysAmount = 0;//4;
