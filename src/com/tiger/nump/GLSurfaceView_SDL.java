...
public class GLSurfaceView_SDL extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private class EglHelper {
        ...
        public void start(){
            ...
            if(DBG) Log.v("SDL", "GLSurfaceView_SDL::EglHelper::start(): creating GL context");
            /*
             * Get an EGL instance
             */
        ...
        public GL createSurface(SurfaceHolder holder) {
            if(DBG) Log.v("SDL", "GLSurfaceView_SDL::EglHelper::createSurface(): creating GL context");
            /*
        ...
        public void finish() {
            if(DBG) Log.v("SDL", "GLSurfaceView_SDL::EglHelper::finish(): destroying GL context");
            if (mEglSurface != null) {
                mEgl.eglMakeCurrent(mEglDisplay, EGL10.EGL_NO_SURFACE,
    ...
    class GLThread extends Thread implements SwapBuffersCallback {
        ...
        public void onPause() {
            if(!AppConfig.RELEASE) Log.v("SDL", "GLSurfaceView_SDL::onPause()");
            synchronized (this) {
                mPaused = true;
            }
        }
        ...
        public void onResume() {
        	if(!AppConfig.RELEASE) Log.v("SDL", "GLSurfaceView_SDL::onResume()");
            synchronized (this) {
                mPaused = false;
                notify();
            }
    ...
    static class LogWriter extends Writer {
        ...
        private void flushBuilder() {
            if (mBuilder.length() > 0) {
            	if(!AppConfig.RELEASE) Log.v("GLSurfaceView", mBuilder.toString());
