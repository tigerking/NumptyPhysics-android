...
class DemoRenderer extends GLSurfaceView_SDL.Renderer {
	...
	final static String LOG_TAG="DemoRenderer";
	...
	public void onDrawFrame(GL10 gl) {
		...
		if(DBG) Log.d(LOG_TAG, "ENTER onDrawFrame");
		...
		String libs[] = {};
		if(DBG) Log.d(LOG_TAG, "loading lib (" + libs +")");
		...
		if(DBG) Log.d(LOG_TAG, "Load libs done.");

		Settings.Apply(context);
		accelerometer = new AccelerometerReader(context);
		
		if(DBG) Log.d(LOG_TAG, "CK1");
		...
		if(DBG) Log.d(LOG_TAG, "nativeInit...");
		...
		if(DBG) Log.d(LOG_TAG, "nativeInit() done. quiting ...");
		System.exit(0); // The main() returns here - I don't bother with deinit stuff, just terminate process
		
		if(DBG) Log.d(LOG_TAG, "LEAVE onDrawFrame");
	}
	...
	public int swapBuffers() // Called from native code
	{
		...
		//if(DBG) Log.d(LOG_TAG, "java swapBuffers " + (++frames));
...
class DemoGLSurfaceView extends GLSurfaceView_SDL {
	...
	final static String LOG_TAG="DemoGLSurfaceView";
	...
	public boolean onKeyDown(int keyCode, final KeyEvent event) {
		//if(DBG) Log.d(LOG_TAG,"Video KeyDown(code=" +keyCode +")");
		
		//++TIGERKING
		if( filterKey(keyCode)){
	...
	public boolean onKeyUp(int keyCode, final KeyEvent event) {
		//if(DBG) Log.d(LOG_TAG,"Video KeyUp(code=" +keyCode +")");
